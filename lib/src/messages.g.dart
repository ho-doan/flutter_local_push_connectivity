...
class LocalPushConnectivityModel {
  ...
  bool operator ==(Object other) {
    if (other is! LocalPushConnectivityModel || other.runtimeType != runtimeType) {
      return false;
    }
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    ...
    }    else if (value is ConnectType) {
      buffer.putUint8(130);
      writeValue(buffer, value.index);
    }    else if (value is LocalPushConnectivityModel) {
      buffer.putUint8(131);
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 130: 
        final int? value = readValue(buffer) as int?;
        return value == null ? null : ConnectType.values[value];
      case 131: 
        return LocalPushConnectivityModel.decode(readValue(buffer)!);
      default:
...
class LocalPushConnectivityHostApi {
  ...
  Future<void> initialize(LocalPushConnectivityModel model) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.flutter_local_push_connectivity.LocalPushConnectivityHostApi.initialize$pigeonVar_messageChannelSuffix';
  ...
  Future<void> connect(LocalPushConnectivityModel model) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.flutter_local_push_connectivity.LocalPushConnectivityHostApi.connect$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
